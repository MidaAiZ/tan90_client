...
function createCourse(course) {
	...
	<li>\
		<div class='course-grid' data-id='" + course.id + "'>\
		  	<a data-href='/view/lesson.html?chapter_index=1&lesson_index=1&course_id=" + course.id + "'>\
...
function createTrailer(course) {
	...
	<div class='sub-trailer'>\
		<div class='col-md-4 sub-img'>\
			<a data-href='/view/lesson.html?chapter_index=1&lesson_index=1&course_id=" + course.id + "'><img src='" + IMGROOT + course.cover + "' alt='img07'/></a>\
		</div>\
